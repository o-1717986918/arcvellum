...
**当前版本：v0.99.7 Beta。** [下载 Windows 安装包](https://github.com/o-1717986918/arcvellum/releases/tag/v0.99.7) · [阅读发行说明](docs/releases/v0.99.7.md) · [查看验证记录](docs/releases/v0.99.7-verification.md)
...
v0.99.7 的 Windows 生产构建与签名更新包、macOS Apple Silicon 和 Intel **未签名预览包**由同一标签工作流生成。macOS 包尚未经过 Developer ID 签名和 Apple notarization，暂不按普通用户稳定版介绍。
...
发布验证涵盖 Python、Vue、Pi Worker、Prompt Registry、提示词评估、架构审计与版本同步检查。[详细结果](docs/releases/v0.99.7-verification.md)。
