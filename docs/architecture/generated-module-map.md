...
| `src/literary_engineering_studio_engine/routes` | 47 | Formal route catalog | `routes/catalog.py` | tasking and literary services | Studio lifecycle |
...
| `src/literary_engineering_studio_engine/literary` | 160 | Literary domain | `domain package exports` | foundation and task contracts | FastAPI or Provider SDKs |
...
| `workers/pi-worker/src` | 15 | Bounded Pi Worker | `main.ts / worker.ts` | Pi SDK and task contract | formal project access |
