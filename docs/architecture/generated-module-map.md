...
| `src/literary_engineering_studio_engine/literary` | 153 | Literary domain | `domain package exports` | foundation and task contracts | FastAPI or Provider SDKs |
...
| `src/literary_engineering_studio/preflight` | 27 | Writeback validation | `task_preflight facade` | contracts and deterministic validators | Agent creativity |
