...
|---|---:|---|---|---|---|
| `src/literary_engineering_studio_engine/foundation` | 13 | Engine foundation | `package exports` | standard library | Studio runtime or UI |
| `src/literary_engineering_studio_engine/tasking` | 31 | Formal task contracts | `tasking/__init__.py` | Engine foundation | Agent execution |
| `src/literary_engineering_studio_engine/routes` | 54 | Formal route catalog | `routes/catalog.py` | tasking and literary services | Studio lifecycle |
...
| `src/literary_engineering_studio_engine/literary` | 182 | Literary domain | `domain package exports` | foundation and task contracts | FastAPI or Provider SDKs |
| `src/literary_engineering_studio_engine/prompting` | 12 | Prompt programs | `prompt registry/compiler` | literary contracts | Provider transport |
...
| `src/literary_engineering_studio/application` | 55 | Studio use cases | `application services` | ports and Engine contracts | API/framework adapters |
| `src/literary_engineering_studio/automation` | 17 | Campaign control | `automation/controller.py` | application/runtime ports | Engine route implementations |
...
| `src/literary_engineering_studio/preflight` | 30 | Writeback validation | `task_preflight facade` | contracts and deterministic validators | Agent creativity |
| `src/literary_engineering_studio/observability` | 36 | Events and telemetry | `observability projections` | event contracts | task mutation |
...
| `src/literary_engineering_studio/api` | 26 | HTTP/SSE adapters | `router factories` | application use cases | direct project mutation |
...
| `workers/pi-worker/src` | 20 | Bounded Pi Worker | `main.ts / worker.ts` | Pi SDK and task contract | formal project access |
...
| `creative-live` | 16 | 只通过 feature client、共享只读合同或命令总线跨域协作 |
...
| `orrery` | 76 | 只通过 feature client、共享只读合同或命令总线跨域协作 |
| `project-agent` | 13 | 只通过 feature client、共享只读合同或命令总线跨域协作 |
