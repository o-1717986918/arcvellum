...
| `src/literary_engineering_studio_engine/workflow` | 37 | Workflow projections | `workflow_state facade` | tasking and routes | Runtime adapters |
| `src/literary_engineering_studio_engine/literary` | 183 | Literary domain | `domain package exports` | foundation and task contracts | FastAPI or Provider SDKs |
...
| `src/literary_engineering_studio/automation` | 19 | Campaign control | `automation/controller.py` | application/runtime ports | Engine route implementations |
...
| `project-agent` | 15 | 只通过 feature client、共享只读合同或命令总线跨域协作 |
