...
| `workers/pi-worker/src` | 16 | Bounded Pi Worker | `main.ts / worker.ts` | Pi SDK and task contract | formal project access |
...
| `orrery` | 69 | 只通过 feature client、共享只读合同或命令总线跨域协作 |
