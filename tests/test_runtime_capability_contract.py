...
class RuntimeCapabilityContractTests(unittest.TestCase):
    ...
    def test_pi_worker_declares_bounded_agent_controls_without_general_shell(self):
        ...
        self.assertIn("provider-circuit-breaker", capabilities)
        self.assertIn("provider-error-classification", capabilities)
        self.assertIn("provider-retry-control", capabilities)
        self.assertIn("silence-timeout-control", capabilities)
