...
export const router = createRouter({
  ...
  routes: [
    { path: "/", redirect: { name: "project-agent" } },
    ...
    { path: "/strategy", name: "strategy", redirect: () => agentWorkspace("quality"), meta: { label: "质量与节奏" } },
    { path: "/observatory", name: "observatory", redirect: { name: "project-agent" }, meta: { label: "Agent 工作" } },
