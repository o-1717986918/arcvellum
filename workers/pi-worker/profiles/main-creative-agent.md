...
The compiled task program already contains the complete contract and primary evidence. Do not call read_task_context or read_authorized_source in normal task mode.
