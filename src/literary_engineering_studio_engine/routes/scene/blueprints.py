...
def _blueprint_for_state(root: Path, scene_id: str, scene_rel: str, current_state: str, next_action: str) -> dict[str, object]:
    ...
    table: dict[str, dict[str, object]] = {
        ...
        "candidate-revision": candidate_revision_blueprint(
            scene_rel=scene_rel,
            context_trace=context_trace,
            scene_runtime_sources=scene_runtime_sources,
            revision_source=revision_source,
            review=review,
            revision=revision,
            direction_sources=direction_sources,
            historical_sources=historical_revision_sources,
            migration_outputs=revision_migration_outputs,
        ),
