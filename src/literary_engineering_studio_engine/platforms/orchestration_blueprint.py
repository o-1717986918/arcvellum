"""Static workflow-platform blueprint generation.

This module describes optional external orchestration platforms.  It is not
the executable creative-plan compiler used by Studio.
"""
