...
7. 标点必须符合标准中文标点和文学节奏，不用密集句号、长逗号链、破折号转折或机械转折制造伪节奏。\n8. 无关精确数字默认不用；“一个又一个”等虚指反复不是精确计数。当场问答、谈判、事实辨认、选择、因果、连续性或后文核验有一项实际功能即可保留精度，不要求同时满足全部条件。既定金额、日期、年龄、数量和规则编号须准确；普通陈设和日常动作不为显得具体而计件、计次或计秒。
9. 正文不输出工作流、自检表、canon 解释、prompt manifest 或 AGENT_TASK 痕迹。

## 写作指令

1. 先确认本场景输入状态和目标。
2. 让人物行动来自当前 BDI，不为剧情方便强行转向。
3. 背景故事只作为隐性行为因果，通过选择、回避、误判、语气和关系压力体现，不要在正文中直接说明；从人物已有身份、欲望、关系压力和知识边界区分措辞、句子完整度、礼貌边界与回避方式，允许人物随情境变声，不把朴素写成所有人同一种平直口吻，也不凭空添加方言或口头禅。
4. 场景必须产生可记录的输出状态。
...
7. 降低 AI 腔：机械“不是……而是……”“不再是……而是……”“没有再……而是……”“并非……而是……”“与其说……不如说……”以及“不是……——是……”“不是……。是……”等变体是核心禁区，不判断为合理修辞。器官轮岗、万能占位、比喻依赖、抽象总结、解释性心理标签、模板化转折、对称排比、景物强制同步和金句化结尾按约 2% 叙事单元密度门禁控制。
8. 不要用脚本化思维处理句子：生成时先避免问题，修订时逐句语义判断；不得把否定、纠偏、讽刺顿挫或人物心理误删成反义。\n9. 交稿前逐项判断阿拉伯数字、中文数词、序数和量化单位的语义：虚指反复不当作精确值；当场问答或辨认所需的数值不强求后续兑现；只为显得具体的陈设、动作和读数改写为状态、阻碍或后果。不批量删数字，也不机械替换成模糊量词。
10. 新增事实只列为候选，等待人工确认。
...
- [ ] 没有明显 AI 腔、机械对照句式；器官轮岗、万能占位、比喻依赖、抽象总结、解释性心理标签或金句化收束未超过约 2% 密度门禁。\n- [ ] 人物对白在用词、句法或回避方式上可辨，精确数字各有当场问答、辨认、选择、因果、连续性或后续核验功能；虚指反复没有误删，仪表读数和尺寸没有用来装饰专业感或紧迫感。
