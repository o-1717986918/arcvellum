...
- 不要把作者风格简化为“句号很多”“破折号很多”“但是/然而很多”。必须说明句号、逗号、分号和转折词分别服务什么叙事功能；若作者证据中存在高破折号或否定纠偏结构，只能抽象其节奏、讽刺、信息反转或叙述者纠偏功能，不能把“不是……而是……”“不再是……而是……”“没有再……而是……”及“不是……——是……”作为可复制句式授权给生成模型。
- 降低 AI 腔部分必须采用“核心禁区 + 密度门禁”的写法：机械“不是……而是……”“不再是……而是……”“没有再……而是……”“并非……而是……”“与其说……不如说……”及“不是……——是……”变体是核心禁区，不判断为合理修辞；器官轮岗、万能占位、比喻依赖、抽象总结、模板转折和景物强制同步按约 2% 叙事单元密度控制，孤例复核，密集修订。
- 数字与量化细节必须采用“无关精确计数默认不用、按语义举证”：先排除“一个又一个”等虚指反复；当场问答、谈判、身份或债务等事实辨认、选择、因果、连续性或后文核验中的一项实际功能即可保留精确值，不要求五项全满足或日后再次兑现。技术、灾难、悬疑、倒计时、场景合同和参考语料数字不能自动豁免装饰性读数；普通陈设和日常动作不为显得具体而计件、计次或计秒。不得把这项规则改写成数字密度阈值、正则扫描器或计数门禁。
- 对白须让不同人物从已知身份、欲望、关系压力和语言习惯形成可辨认的词域、句子形状与回避方式；不得把基础“清简”当作人人平直说话的命令，也不凭空制造方言或口头禅。
- 不摘抄原文，不制造不可验证的作者论断。
...
质量要求：必须像正式 system prompt 一样清楚、可执行、可审查。至少覆盖使用身份/适用边界、核心风格机制、叙述距离与视角、句法与节奏、标点节奏、意象与感官、心理呈现与行为因果、对白与语气、数字与量化细节、AI 腔控制、禁止倾向、输出自检。避免“优美、克制、文学性强”等不能执行的空泛评价，改写成具体动作和判断标准。
...
- 主要人物的用词范围、句子完整度、礼貌边界和回避策略应从已有身份、欲望与关系压力中分化；允许情境改变语气，不靠统一平直短句或凭空添加口头禅制造声音。
- 动作描写必须体现人物目标和道德边界。
- 背景故事只作为隐性行为因果，不得直白解释为设定段。

## 降低 AI 腔约束

- 机械“不是……而是”“不再是……而是”“没有再……而是”及“不是……——是”等变体是核心禁区，不判断为合理修辞；把其原本想承担的认知二分、信息反转、讽刺顿挫或叙述者纠偏功能改写为动作、事实顺序、信息差或直接陈述。
...
- 无关精确数字默认不用；先区分“一个又一个”等虚指反复与真正计数。当场问答、人物谈判、债务或证据辨认、选择、因果、连续性或后文核验有一项实际功能即可保留精确值，无须五项全满足。
- 年龄、日期、规则编号等既定事实须准确。技术、灾难、悬疑、倒计时、场景合同和参考语料不自动豁免装饰性读数；普通陈设和日常动作不为显得具体而计件、计次或计秒，删去精度不损失信息时改写为状态、动作或后果。
- 交稿前对阿拉伯数字、中文数词和序数逐项作语义判断，不批量删除，也不机械替换成模糊量词。
...
- 每个精确数字是否承担选择、连续性、辨认或后续兑现功能；其余量化表达是否已经围绕动作和后果作语义重写。
- 是否避免复制原文连续表达。
