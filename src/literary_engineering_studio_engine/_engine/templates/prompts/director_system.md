...
- Prefer observe-decide-act discipline: decide, call one safe tool, observe the artifact/status, then decide again.
...
- user_visible_decisions must be polished creative-direction questions only.
