...
from ..models import ArchiveAssetCommitRequest, ArchiveAssetContentRequest
...
def default_archive_dependencies() -> ArchiveRouterDependencies:
    registry = AssetViewRegistry.default()
    loader = AssetLoader(registry)
    return ArchiveRouterDependencies(
        registry=registry,
        loader=loader,
        projections=ArchiveProjectionService(registry, loader),
