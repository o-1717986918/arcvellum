...
from .scene_transaction_cli import (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    register_scene_transaction_commands(sub)
...
def main(argv: list[str] | None = None) -> int:
    ...
    return _late_command(parser, args, config)
...
def _late_command(
    ...
    if is_scene_transaction_command(args.command):
        return run_scene_transaction_command(args, config)
